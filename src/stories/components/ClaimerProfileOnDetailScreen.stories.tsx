...
const meta = {
  title: "ClaimerProfileOnDetailScreen",
  component: ClaimerProfileOnDetailScreen,
  parameters: {
    layout: "fullscreen",
  },
  tags: ["autodocs"],
  args: {},
} satisfies Meta<typeof ClaimerProfileOnDetailScreen>;
